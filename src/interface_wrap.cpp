...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__msr

#else
#  define SWIG_init    init_msr

#endif
#define SWIG_name    "_msr"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_reconstruct(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOO:reconstruct",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5)) SWIG_fail;
  {
    npy_intp size[2] = {
      -1, -1 
    };
  ...
  }
  {
    ...
    array7 = obj_to_array_contiguous_allow_conversion(obj2, NPY_INT,
      &is_new_object7);
  ...
  }
  {
    ...
    array12 = obj_to_array_contiguous_allow_conversion(obj4, NPY_DOUBLE,
      &is_new_object12);
  ...
  }
  {
    ...
    arg16 = (int) PyInt_AsLong(obj5);
    dims[0] = (npy_intp) arg16;
    array15 = PyArray_SimpleNew(1, dims, NPY_DOUBLE);
    if (!array15) SWIG_fail;
    arg15 = (double*) array_data(array15);
  }
  reconstruct(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16);
  resultobj = SWIG_Py_Void();
  {
    resultobj = SWIG_Python_AppendOutput(resultobj,array15);
  }
  {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "reconstruct", _wrap_reconstruct, METH_VARARGS, (char *)"Computes an all-arom state: reconstruct(coords, CG, indices, lengths, CGOP) -> coords"},
	 { NULL, NULL, 0, NULL }
};
